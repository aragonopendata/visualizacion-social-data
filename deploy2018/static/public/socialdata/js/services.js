  ...
  .factory('drawers', function (helpers) {
    ...
    drawers.drawWeeklyCloud = function (scope, response) {
      ...
      Object.keys(response).forEach(year => {
        ...
        scope['timelineSwiper' + year] = new Swiper(".timeline .swiper-container-" + year, {
          direction: "vertical",
          loop: false,
          speed: 1600,
          ...
          paginationBulletRender: function (swiper, index, className) {
            ...
            if (activeIndex == index) { return '<span class="' + className + ' swiper-pagination-bullet-active">' + week + "</span>" }
